...
public class PersonValidator {
    public static List<String> validate(Person e, Boolean code_duplicate_check_flag, Boolean password_check_flag) {
    ...
    private static String _validateCode(String code, Boolean code_duplicate_check_flag) {
        ...
        if(code_duplicate_check_flag) {
            ...
            long persons_count = (long)em.createNamedQuery("checkRegisteredCode", Long.class)
