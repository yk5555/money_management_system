...
public class PersonsUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            Person e = em.find(Person.class, (Integer)(request.getSession().getAttribute("person_id")));
            ...
            List<String> errors = PersonValidator.validate(e, code_duplicate_check, password_check_flag);
            if(errors.size() > 0) {
                em.close();
